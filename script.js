...
form.addEventListener("submit", function (event) {
  ...
  try {
    ...
    if (!nameInput || !emailInput || !messageInput) {
      throw new Error("Form inputs not found. Please check the form structure.");
    }
    ...
    emailjs.send("service_6pd9iba", "template_jbw3c3g", templateParams)
      .then(response => {
        alert("Message sent successfully! ✅");
        form.reset(); // Clear form fields after successful submission
        formBtn.setAttribute("disabled", ""); // Disable submit button after successful submission
      })
      .catch(error => {
